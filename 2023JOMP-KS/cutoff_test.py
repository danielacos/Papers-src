...
# test = "blow-up"
# test = "blow-up_eps-1e-6"
# test = "blow-up_eps-1e-14"
# test = "three-balls_14"
# test = "sin-cos_6"
# test = "sin-cos_6_1_eps-0"
test = "sin-cos_6_1_eps-1e-10"
variable = "u" # u or v

save_vtk = 0 # Save the approximation in pvd file

if test=="blow-up":
    func_1 = "non_truncated_u/blow-up/test-9_nx-1000_T-0,0001/"
    func_2 = "truncated_u/blow-up/test-9_nx-1000_T-0,0001/"
    nx = 1000
    counter = 10
if test=="blow-up_eps-1e-6":
    func_1 = "non_truncated_u/blow-up/test-9_nx-1000_T-0,0001_eps-1e-6/"
    func_2 = "truncated_u/blow-up/test-9_nx-1000_T-0,0001_eps-1e-6/"
    nx = 1000
    counter = 10
if test=="blow-up_eps-1e-14":
    func_1 = "non_truncated_u/blow-up/test-9_nx-1000_T-0,0001_eps-1e-14/"
    func_2 = "truncated_u/blow-up/test-9_nx-1000_T-0,0001_eps-1e-14/"
    nx = 1000
    counter = 10
    ...
    func_1 = "non_truncated_u/sin-cos/test-6/"
    func_2 = "truncated_u/sin-cos/test-6/"
    nx = 400
    counter = 10
elif test=="sin-cos_6_1_eps-0":
    func_1 = "non_truncated_u/sin-cos/test-6_1_eps-0/"
    func_2 = "truncated_u/sin-cos/test-6_1_eps-0/"
    nx = 50
    counter = 2
elif test=="sin-cos_6_1_eps-1e-10":
    func_1 = "non_truncated_u/sin-cos/test-6_1_eps-1e-10/"
    func_2 = "truncated_u/sin-cos/test-6_1_eps-1e-10/"
    nx = 50
    counter = 40
