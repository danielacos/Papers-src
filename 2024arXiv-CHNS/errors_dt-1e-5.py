...
mesh_ex = adx.read_mesh(comm, "decoupled/decoupled_order_nx-200_dt-1e-5/NSCH_DG-UPW_decoupled_order_mesh", engine='BP4', ghost_mode=dolfinx.mesh.GhostMode.none)
...
adx.read_function(p1c_phi_ex, "decoupled/decoupled_order_nx-200_dt-1e-5/NSCH_DG-UPW_decoupled_order_p1c_phi_i-50")
adx.read_function(phi_ex, "decoupled/decoupled_order_nx-200_dt-1e-5/NSCH_DG-UPW_decoupled_order_phi_i-50")
adx.read_function(u_ex, "decoupled/decoupled_order_nx-200_dt-1e-5/NSCH_DG-UPW_decoupled_order_u_i-50")
adx.read_function(p_ex, "decoupled/decoupled_order_nx-200_dt-1e-5/NSCH_DG-UPW_decoupled_order_p_i-50")
...
for file in ["decoupled/decoupled_order_nx-40_dt-1e-5", "decoupled/decoupled_order_nx-60_dt-1e-5", "decoupled/decoupled_order_nx-80_dt-1e-5", "decoupled/decoupled_order_nx-105_dt-1e-5", "decoupled/decoupled_order_nx-120_dt-1e-5"]:

    mesh_approx = adx.read_mesh(comm, file+"/NSCH_DG-UPW_decoupled_order_mesh", engine='BP4', ghost_mode=dolfinx.mesh.GhostMode.none)
    ...
    adx.read_function(p1c_phi_approx, file+"/NSCH_DG-UPW_decoupled_order_p1c_phi_i-50")
    adx.read_function(phi_approx, file+"/NSCH_DG-UPW_decoupled_order_phi_i-50")
    adx.read_function(u_approx, file+"/NSCH_DG-UPW_decoupled_order_u_i-50")
    adx.read_function(p_approx, file+"/NSCH_DG-UPW_decoupled_order_p_i-50")
